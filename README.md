...
`tools/fusion/compute_galley_panels.py` then explains the simple carcass panels
using documented assumptions: side panels are `Height x Depth`, top/bottom fit
